...
public class LibraryLoginTest {
    ...
    public void required_field_error_message_test() {
        ...
        //LibraryLoginPage libraryLoginPage = new LibraryLoginPage();// all methods I can reach from pages now
        ...
        @Test
    public void invalidEmail_format_error_message_test() {
    ...
    public void library_negative_login_test(){
        ...
        //LibraryLoginPage libraryLoginPage = new LibraryLoginPage();
        libraryLoginPage.inputUsername.sendKeys("inccorrect@email.com");
        libraryLoginPage.signInButton.click();
