...
public class ReadingProperties {
    ...
    public void reading_from_properties_file_test() throws IOException {
        ...
        //it is key sensitive it has to be exactly the same
        System.out.println("properties.getProperty(\"env\") = " + properties.getProperty("env")); // shortcut for
        // print properties.getProperty("env").soutv
