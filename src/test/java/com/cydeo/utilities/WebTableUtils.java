 ...
 */
    public static String returnOrderDate(WebDriver driver, String customerName){
        ...
        WebElement customerOrderDate = driver.findElement(By.xpath("//td[.='"+customerName+"']/following-sibling::td" +
                "[3]"));
 ...
 */
    ...
    public static void orderVerify(WebDriver driver,String costumerName,String expectedOrderDate){
        ...
        String actualOrderDate = returnOrderDate(driver,costumerName);// instead of we can use it
